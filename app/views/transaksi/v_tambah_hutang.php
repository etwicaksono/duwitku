    ...
    <div class="row">
        <div class="col-lg-3 mb-4">
            <a href="" class="btn btn-primary" data-toggle="modal" data-target="#newCreditModal"
                id="tambahPemasukan">Tambah Hutang</a>
        </div>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="text-center">
                        <a href="#" class="btn btn-success my-1 tampilEditModal" data-toggle="modal"
                            data-target="#newCreditModal" data-id="<?= $tr['id']; ?>"><i
...
<div class="modal fade" id="newCreditModal" tabindex="-1" role="dialog" aria-labelledby="newCreditModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= BASEURL; ?>/transaksi/c_tambahHutang" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <?php
                            $akun = $this->model('M_transaksi')->getDebtAccount($_SESSION['user']['id']);
